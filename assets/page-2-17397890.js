             ...
             <img class="images" src="${n}"
              alt="${r}" loading="lazy" />
                <div class="info">
                   ...
                   <p class="info-item"><b>Comments</b> <br>${p}</p>
...
//# sourceMappingURL=page-2-17397890.js.map
